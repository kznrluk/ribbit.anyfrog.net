...
## 20221008 追記
仕方なく宅内にDNS建てるかと思ってルーターの設定項目を確認したんですが、DHCPで広報されるDNSサーバーを設定する欄がないんですよね。
さらにそのDHCPをオフにすることもできないので、自前でDHCPサーバーを建てることも不可能。あ～あ。

transix+IPIPに対応していてある程度簡単に使えそうということからこのルーターを選びましたが、自分のユースケースではかなり機能不足でした。管理画面のURLを見るとOpenWRTベースであるのがわかるので、なんかこう、設定項目増やすとかできなかったんですかね。残念です。